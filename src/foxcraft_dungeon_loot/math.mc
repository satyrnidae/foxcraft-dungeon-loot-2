...
function random {
    ...
    !IF(config.dev) {
        tellraw @s ["", {"text":"Randomizer output the following number: ","color":"gray","italic":true},{"score":{"name":"#random","objective":"<%config.internalScoreboard%>"},"color":"gray","italic":true}]
    }
