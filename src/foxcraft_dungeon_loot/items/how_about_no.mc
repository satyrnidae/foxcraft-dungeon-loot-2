...
function give {
    give @s minecraft:warped_fungus_on_a_stick{DungeonLootId:46,Unbreakable:1,CustomModelData:421959,display:{Name:'[{"text":"How About No?","italic":false,"color":"green"}]',Lore:['[{"text":"\\"I can\'t deal with this right now. Do you","italic":true}]','[{"text":"know how much I got going on? I have","italic":true}]','[{"text":"things to do! I can\'t be here that long!","italic":true}]','[{"text":"Go on! Get!\\"","italic":true}]','[{"text":"Rarity: ","italic":true},{"text":"Mythic","color":"green","italic":true},{"text":"","color":"dark_purple","italic":false}]','[{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"I Don\'t Have Time For This: ","italic":false,"color":"green"},{"text":"Upon use, kills","italic":false,"color":"gray"}]','[{"text":"all hostile mobs in a 50-meter radius.","italic":false,"color":"gray"},{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"Fragile:","italic":false,"color":"red"},{"text":" This item is consumed after use.","color":"gray"}]']},Enchantments:[{id:"minecraft:mending",lvl:1}],HideFlags:5} 1
}
