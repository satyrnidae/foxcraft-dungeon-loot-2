...
function clock_3s {
    ...
    execute as @a at @s if score @s satyrn.fdl.itemId.mainHand matches 76 run {
        ...
        execute as @e[type=#foxcraft_dungeon_loot:livestock, distance=..5, predicate=foxcraft_dungeon_loot:items/love_wheat/has_age_0, limit=10, sort=nearest] at @s run {
