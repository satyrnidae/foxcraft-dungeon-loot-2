...
function clock_3s {
    ...
    execute as @a at @s if score @s satyrn.fdl.itemId.mainHand matches 76 run {
        ...
        execute if entity @e[type=#foxcraft_dungeon_loot:livestock, distance=..5, nbt={Age: 0}, limit=10, sort=nearest] as @e[type=#foxcraft_dungeon_loot:livestock, distance=..5, nbt={Age: 0}, limit=10, sort=nearest] at @s run {
...
function on_load {
    schedule function foxcraft_dungeon_loot:items/love_wheat/clock_3s 15t
}
